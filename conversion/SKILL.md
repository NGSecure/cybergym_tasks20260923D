...
> **This repo (cybergym_tasks20260923D).** The prime bundles live under
> `cybergym_tasks20260923D/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923D/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923D
# one bundle
